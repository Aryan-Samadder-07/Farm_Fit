        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-2xl shadow-sm space-y-6">
            ...
            <form onSubmit={handleFarmerDiagnose} className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-slate-500">Farmer Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-500">Crop Category</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-500">Voice Transcript Description</label>
                <textarea
                  rows={3}
                  placeholder="E.g. Yellow leaves on lower branches..."
                  value={problemTranscript}
                  onChange={(e) => setProblemTranscript(e.target.value)}
                  className="mt-1.5 w-full bg-white border border-slate-300 focus:border-slate-500 rounded-xl px-4 py-2.5 text-sm text-slate-800 focus:outline-none transition duration-150 resize-none"
                  required
                />
              </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-500 mb-1.5">Upload Leaf/Crop Health Images (Up to 3)</label>
                <div className="relative group border border-dashed border-slate-300 hover:border-slate-400 bg-slate-50 rounded-2xl p-6 text-center cursor-pointer transition">
                  <input
                    type="file"
                    accept="image/*"
                    multiple
                  ...
                  <div className="py-2 space-y-2">
                    <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-slate-500 mx-auto shadow-sm border border-slate-200">
                      <ImageIcon className="h-5 w-5" />
                    </div>
                    <div className="text-xs text-slate-500 font-medium">
                      <span className="text-slate-800 font-bold underline">Select images</span> or drag files
                    </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-500 mb-1.5">Farm Location (GPS)</label>
                <button
                  type="button"
          ...
          <div className="space-y-6">
            {diagnosisResult ? (
              <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-2xl shadow-sm space-y-6">
                ...
                <div className="space-y-4">
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                    ...
                    <span className="text-lg font-black text-slate-900 mt-1 block">{diagnosisResult.disease_name}</span>
                  </div>
              ...
              <div className="text-center py-32 bg-white border border-slate-200 rounded-3xl h-full flex flex-col justify-center items-center shadow-sm">
                <Cpu className="h-12 w-12 text-slate-400 stroke-1 mx-auto" />
                <h3 className="text-lg font-bold text-slate-600 mt-4">Waiting for Diagnostic Inputs</h3>
