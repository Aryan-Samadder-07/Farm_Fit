...
class AgronomyService:
    ...
    async def recommend_crops(
        ...
        try:
            ...
            # Updated to call the newer gemini-2.5-flash model which has active free tier quota
            ...
            err_str = str(e)
            print(f"[AgronomyService] Entering intelligent rule-based crop recommendation fallback. Reason: {e}")
